...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.style_adaptive_layer_norm = norm_type == "SALN"
        ...
        elif self.style_adaptive_layer_norm:
            self.norm1 = StyleAdaptiveLayerNorm(dim, condition_dim)
        else:
    ...
    def forward(
        ...
        if self.use_ada_layer_norm:
            ...
            norm_hidden_states = self.norm1(hidden_states, condition)
        else:
        ...
        if self.attn2 is not None:
            ...
            attn_output = self.attn2(
                norm_hidden_states,
                encoder_hidden_states=(
                    encoder_hidden_states if not self.double_self_attention else None
                ),
